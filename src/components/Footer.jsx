...
export default function Footer() {
    return (
        <>
            <footer className="bg-white pt-160 pb-12 border-t border-border-light">
                <div className="max-w-screen-xl mx-auto px-6 text-center">
                    <h2 className="text-h2 font-bold mb-6 text-primary leading-tight">Trusted by 1,200+ founders.<br />Turning ideas into bold brands.</h2>
                    <p className="text-[16px] text-text-secondary mb-12 max-w-lg mx-auto leading-relaxed">Book a free discovery call to discuss strategy, set goals, and see how we can help you grow.</p>
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-16 opacity-30 grayscale mb-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-left border-t border-border-light pt-16">
                    ...
                    <div className="mt-24 overflow-hidden select-none pointer-events-none pt-8">
                        <h1 className="text-[18vw] font-bold text-center leading-none text-[#F3F4F6] tracking-tighter">Lamosa.</h1>
                    </div>
                    <div className="flex flex-col md:flex-row justify-between items-center text-[11px] font-medium text-text-secondary mt-8 pb-4">
