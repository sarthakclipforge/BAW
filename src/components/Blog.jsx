            ...
            <div className="max-w-screen-xl mx-auto px-6">
                <div className="mt-16 pt-16">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
                        <div>
                            <div id="waypoint-blog" className="w-1.5 h-1.5 bg-accent-new rounded-full mb-4"></div>
                            <p className="text-[10px] font-bold uppercase text-text-secondary tracking-widest mb-3">Blog</p>
                            <h2 className="text-[36px] font-semibold text-primary leading-tight tracking-[-0.02em]">Fresh insights & ideas<br />from the team.</h2>
                        </div>
                        <p className="text-[14px] text-text-secondary max-w-sm mb-1 leading-relaxed">Expert tips, case studies, and trends to help you design, grow, and convert smarter.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white p-2.5 rounded-2xl border border-border-light group cursor-pointer hover:shadow-lg transition-all h-full">
                            <div className="p-5 pb-2">
                                <div className="flex justify-between items-start mb-3">
                                    <div>
                                        ...
                                        <h3 className="font-bold text-xl leading-tight text-primary mb-3">Why Motion Design is the New Differentiator in SaaS</h3>
                                    </div>
                            ...
                            <div className="rounded-lg overflow-hidden h-[240px] bg-black relative mt-auto mx-2 mb-2">
                                ...
                                <span className="absolute top-3 right-3 bg-white/20 backdrop-blur-md text-white text-[9px] font-bold px-2 py-1 rounded">FEATURED</span>
                            </div>
                        </div>
                        <div className="space-y-4">
                            <div className="bg-white p-2.5 rounded-2xl border border-border-light flex gap-5 group cursor-pointer hover:shadow-lg transition-all items-center">
                                <div className="w-[140px] h-[100px] rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                                ...
                                <div className="py-2 pr-3 flex flex-col h-full justify-between flex-1">
                                    <div>
                                        ...
                                        <h3 className="font-bold text-[15px] leading-snug text-primary mb-2">The Psychology Behind High-Converting Landing Pages</h3>
                                    </div>
                                    <div className="flex justify-between items-center mt-auto">
                                        ...
                                        <div className="w-6 h-6 rounded-full border border-border-light flex items-center justify-center bg-white group-hover:bg-primary group-hover:text-white transition-colors">
                            ...
                            <div className="bg-white p-2.5 rounded-2xl border border-border-light flex gap-5 group cursor-pointer hover:shadow-lg transition-all items-center">
                                ...
                                <div className="py-2 pr-3 flex flex-col h-full justify-between flex-1">
                                    <div>
                                        ...
                                        <h3 className="font-bold text-[15px] leading-snug text-primary mb-2">Building an MVP That Doesn't Suck: 6 Rules to Follow</h3>
                                    </div>
                                    <div className="flex justify-between items-center mt-auto">
                                        <div className="flex gap-1">
                                        ...
                                        <div id="waypoint-blog-arrow" className="w-6 h-6 rounded-full border border-border-light flex items-center justify-center bg-white group-hover:bg-primary group-hover:text-white transition-colors">
                                            <span className="material-symbols-outlined text-[13px]">arrow_forward</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="mt-10 flex justify-end">
                        <a className="inline-flex items-center gap-2 text-[13px] font-semibold border border-border-light bg-white text-primary px-5 py-2.5 rounded-pill hover:bg-gray-50 transition-colors shadow-sm" href="#">
                            Read All Articles <span className="material-symbols-outlined text-[15px]">arrow_forward</span>
                        </a>
                    </div>
                </div>
            </div>
